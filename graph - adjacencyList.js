...
class Graph {
  ...
  //remove and Edge (v,w) from the graph
  removeEdge(v, w)  {
  ...
  // printGraph() --> Prints the vertex and adjacency list
  printGraph() {
  ...
  // bfs(v) --> function to performs BFS
  bfs(startingNode) {
...
// adding vertices ...you should add vertices first
